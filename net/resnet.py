...
class ResNet(nn.Module):
    ...
    def _forward(self, x, output_option='norm', val=False):
...
def resnet18(pretrained=False, progress=True, last_stride=0, neck=0, red=1, **kwargs):
    ...
    return _resnet('resnet18', BasicBlock, [2, 2, 2, 2], pretrained, progress,
                   last_stride, neck, red=red, **kwargs)


def resnet34(pretrained=False, progress=True, last_stride=0, neck=0, red=1, **kwargs):
...
def resnet50(pretrained=False, progress=True, last_stride=0, neck=0, red=1, **kwargs):
