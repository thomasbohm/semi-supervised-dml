...
class Evaluator():
    ...
    def _create_tsne_plot_gnn(
        ...
        ax.scatter(*x_lb.T, c=y_lb.tolist(), s=20, alpha=0.6, cmap='tab20', marker='o')
        ax.scatter(*proxies.T, c=list(range(num_p)), s=50, alpha=1, cmap='tab20', marker='*', edgecolors='black', linewidths=0.5)
